...
import 'artticleviews.dart';
class Catogoryview extends StatefulWidget {
String catogrie;
Catogoryview({this.catogrie});
  @override
...
class _CatogoryviewState extends State<Catogoryview> {
  ...
  getnews() async {
    News data = News();
    await data.getnews1(widget.catogrie);
    news = data.Amodel;
    setState(() {
      loading = false;
    });}
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: <Widget>[
              Text("TUSHAR", style: TextStyle(color: Colors.blueAccent,
                  fontSize: 18,
                ...
                Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return CatogoryTile(imageurl: catogri[index].imgurl,
                            catogoryname: catogri[index].Catogoriesname);
                      }),
                ),
                Container(
                  child: ListView.builder(
